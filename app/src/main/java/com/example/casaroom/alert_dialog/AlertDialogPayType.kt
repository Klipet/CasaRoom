...
class AlertDialogPayType(private val context: Context , private val sharedPreferences: SharedPreferences){
    ...
    fun paiment(paymentTypes: List<PaymentTypeDB>, totalPayment: Double, asl: List<BillListDB>){
        try {
            ...
            val paymentTypesAdapter = PayAdapter(paymentTypes, totalPayment,asl,  context, alertDialogPay, respProgres, sharedPreferences)
